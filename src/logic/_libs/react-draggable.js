...
function offsetXYFromParent(evt /*: {clientX: number, clientY: number}*/, offsetParent /*: HTMLElement*/, customXYCalc) /*: ControlPosition*/ {
  ...
  if (customXYCalc) {
    const customXY = customXYCalc(clientX, clientY);
    clientX = customXY.x;
    clientY = customXY.y;
  }

  var x = clientX + offsetParent.scrollLeft - offsetParentRect.left;
  var y = clientY + offsetParent.scrollTop - offsetParentRect.top;
...
function getControlPosition(e /*: MouseTouchEvent*/, touchIdentifier /*: ?number*/, draggableCore /*: DraggableCore*/) /*: ?ControlPosition*/ {
  ...
  return (0, _domFns.offsetXYFromParent)(touchObj || e, offsetParent, draggableCore.props.customXYCalc);
}
...
DraggableCore.propTypes = {
  ...
  customXYCalc: _propTypes2.default.func,
  /**
